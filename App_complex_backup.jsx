...
function Navigation() {
  ...
  return (
    <nav className="nav-glass backdrop-blur-xl sticky top-0 z-50 p-4 animate-fade-in border-b border-white/20">
      <div className="max-w-md mx-auto flex justify-between items-center">
        <div className="flex items-center space-x-3">
          <div className="w-12 h-12 rounded-2xl gradient-primary flex items-center justify-center shadow-xl relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent"></div>
            <Home size={22} className="text-white relative z-10" />
          </div>
          <div>
            <h1 className="text-xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">
              Reporte Estradas
            </h1>
            <p className="text-xs text-white/70 font-medium">Prefeitura Municipal</p>
          </div>
        </div>
        <div className="flex space-x-2">
          <Link 
            ...
            className={`p-3 rounded-2xl transition-all duration-300 ${
              location.pathname === '/' 
                ? 'gradient-primary text-white shadow-xl transform scale-105 border border-white/30' 
                : 'bg-white/10 hover:bg-white/20 text-white hover:scale-105 border border-white/20'
            }`}
          >
            <Home size={18} />
          </Link>
  ...
  return (
    <div className="gradient-bg min-h-screen">
      <div className="max-w-md mx-auto p-4 space-y-6 animate-fade-in">
        <Card className="card-glass hover-lift border-0 shadow-2xl">
          <CardHeader className="text-center pb-6 bg-gradient-to-br from-white/20 to-white/5 rounded-t-3xl">
            <div className="w-20 h-20 mx-auto mb-6 rounded-3xl gradient-primary flex items-center justify-content-center shadow-2xl relative overflow-hidden">
          ...
          <CardContent className="p-6">
            ...
            {/* Tipo do problema */}
            <div className="space-y-4">
              <Label htmlFor="tipo" className="text-lg font-bold text-white flex items-center gap-2">
                🔧 Tipo do Problema
              </Label>
              <select 
                id="tipo"
                ...
                className="input-modern w-full p-4 text-lg rounded-2xl border-2 border-white/20 focus:border-blue-400 transition-all duration-300"
                required
              >
            ...
            {/* Descrição */}
            <div className="space-y-4">
              <Label htmlFor="descricao" className="text-lg font-bold text-white flex items-center gap-2">
              ...
              <Textarea
                ...
                className="textarea-modern w-full p-4 text-lg resize-none rounded-2xl border-2 border-white/20 focus:border-blue-400"
                required
                rows={4}
              />
            </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                {[
                  ...
                  <button
                    ...
                    className={`p-4 rounded-2xl text-center font-bold transition-all duration-300 hover:scale-105 border-2 ${
                      formData.urgencia === urgencia.value 
                        ? `${urgencia.gradient} text-white shadow-2xl scale-105 border-white/30` 
                        : 'bg-white/10 text-white hover:bg-white/20 shadow-lg border-white/20 hover:border-white/40'
                    }`}
                  >
                    <div className="text-3xl mb-2">{urgencia.emoji}</div>
                    <div className="text-sm font-bold mb-1">{urgencia.label}</div>
                    <div className="text-xs opacity-80">{urgencia.desc}</div>
                  </button>
                ))}
              </div>
            </div>
            ...
            <Button 
              type="submit" 
              className="w-full btn-modern gradient-primary text-white py-6 text-xl font-bold shadow-2xl rounded-2xl border-2 border-white/30 hover:scale-105 transition-all duration-300" 
